    ...
    (<div
      ...
      <div className="h-40  relative flex items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-[#5DADE2] z-20  will-change-transform">
          <p
            style={{
              textShadow: "4px 4px 15px rgba(0,0,0,0.5)",
            }}
            className="text-5xl  md:text-6xl lg:text-7xl py-8 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300">
            {revealText}
          </p>
        </motion.div>
        <motion.div
        ...
        <div
          ...
          <p
            className=" text-6xl  md:text-7xl lg:text-8xl py-10 font-bold bg-clip-text text-transparent bg-[#323238]">
            {text}
          </p>
          <MemoizedStars />
        </div>
